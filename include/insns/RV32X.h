...
class RV32X : public RevExt {
  ...
  std::vector<RevInstEntry> RV32XTable = {
    ...
    { RevInstDefaults()
        ...
        .SetImplFunc( eaddi ) },
    { RevInstDefaults()
        .SetMnemonic( "eaddie %extd, %rs1, $imm" )
        .SetOpcode( 0b1111011 )
        .SetFunct3( 0b101 )
        .SetrdClass( RevRegClass::RegGPR )
        .Setrs1Class( RevRegClass::RegGPR )
        ...
        .SetImplFunc( eaddie ) },
    { RevInstDefaults()
        .SetMnemonic( "eaddix %extd, %ext1, $imm" )
        .SetOpcode( 0b1111011 )
        .SetFunct3( 0b100 )
        .SetrdClass( RevRegClass::RegGPR )
        .Setrs1Class( RevRegClass::RegGPR )
    ...
    { RevInstDefaults()
        .SetMnemonic( "eblw  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b11 )
        .SetFunct3( 0b110 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( eblw ) },
    { RevInstDefaults()
        .SetMnemonic( "eblh  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b11 )
        .SetFunct3( 0b001 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( eblh ) },
    { RevInstDefaults()
        .SetMnemonic( "eblhu %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b11 )
        .SetFunct3( 0b101 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( eblhu ) },
    { RevInstDefaults()
        .SetMnemonic( "eblb  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b11 )
        .SetFunct3( 0b000 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( eblb ) },
    { RevInstDefaults()
        .SetMnemonic( "eblbu %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b11 )
        .SetFunct3( 0b100 )
        .SetrdClass( RevRegClass::RegGPR )
    ...
    { RevInstDefaults()
        .SetMnemonic( "ebsw  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b10 )
        .SetFunct3( 0b110 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( ebsw ) },
    { RevInstDefaults()
        .SetMnemonic( "ebsh  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b10 )
        .SetFunct3( 0b001 )
        .SetrdClass( RevRegClass::RegGPR )
        ...
        .SetImplFunc( ebsh ) },
    { RevInstDefaults()
        .SetMnemonic( "ebsb  %rd, %rs1, %rs2, %rs3" )
        .SetOpcode( 0b1011011 )
        .SetFunct2( 0b10 )
        .SetFunct3( 0b000 )
        .SetrdClass( RevRegClass::RegGPR )
