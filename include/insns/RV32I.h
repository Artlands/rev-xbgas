...
class RV32I : public RevExt {
  ...
  std::vector<RevInstEntry> RV32ITable = {
    ...
    RevInstDefaults().SetMnemonic("jalr %rd, %rs1, $imm" ).SetFunct3(   0b000).SetImplFunc(jalr  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b1100111).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) != 0 || DECODE_RD( Inst )  > 1; } ),
    RevInstDefaults().SetMnemonic("jalr %rs1"            ).SetFunct3(   0b000).SetImplFunc(jalr  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b1100111).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) == 0 && DECODE_RD( Inst ) == 1; } ),
    RevInstDefaults().SetMnemonic("jr %rs1"              ).SetFunct3(   0b000).SetImplFunc(jalr  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b1100111).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) == 0 && DECODE_RD( Inst ) == 0 && DECODE_RS1( Inst ) != 1; } ),
    RevInstDefaults().SetMnemonic("ret"                  ).SetFunct3(   0b000).SetImplFunc(jalr  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b1100111).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) == 0 && DECODE_RD( Inst ) == 0 && DECODE_RS1( Inst ) == 1; } ),
    ...
    RevInstDefaults().SetMnemonic("lb %rd, $imm(%rs1)"   ).SetFunct3(   0b000).SetImplFunc(lb    ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0000011),
    RevInstDefaults().SetMnemonic("lh %rd, $imm(%rs1)"   ).SetFunct3(   0b001).SetImplFunc(lh    ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0000011),
    RevInstDefaults().SetMnemonic("lw %rd, $imm(%rs1)"   ).SetFunct3(   0b010).SetImplFunc(lw    ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0000011),
    RevInstDefaults().SetMnemonic("lbu %rd, $imm(%rs1)"  ).SetFunct3(   0b100).SetImplFunc(lbu   ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0000011),
    RevInstDefaults().SetMnemonic("lhu %rd, $imm(%rs1)"  ).SetFunct3(   0b101).SetImplFunc(lhu   ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0000011),
    ...
    RevInstDefaults().SetMnemonic("addi %rd, %rs1, $imm" ).SetFunct3(   0b000).SetImplFunc(addi  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) != 0; } ),
    RevInstDefaults().SetMnemonic("mv %rd, %rs1"         ).SetFunct3(   0b000).SetImplFunc(addi  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) == 0 && ( DECODE_RS1( Inst ) != 0 || DECODE_RD( Inst ) != 0 ); } ),
    RevInstDefaults().SetMnemonic("nop"                  ).SetFunct3(   0b000).SetImplFunc(addi  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ){ return DECODE_IMM12( Inst ) == 0 && ( DECODE_RS1( Inst ) == 0 && DECODE_RD( Inst ) == 0 ); } ),
    RevInstDefaults().SetMnemonic("slti %rd, %rs1, $imm" ).SetFunct3(   0b010).SetImplFunc(slti  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011),
    RevInstDefaults().SetMnemonic("sltiu %rd, %rs1, $imm").SetFunct3(   0b011).SetImplFunc(sltiu ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ) { return DECODE_IMM12( Inst ) != 1; } ),
    RevInstDefaults().SetMnemonic("seqz %rd, %rs"        ).SetFunct3(   0b011).SetImplFunc(sltiu ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ) { return DECODE_IMM12( Inst ) == 1; } ),
    RevInstDefaults().SetMnemonic("xori %rd, %rs1, $imm" ).SetFunct3(   0b100).SetImplFunc(xori  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ) { return SignExt( DECODE_IMM12( Inst ), 12 ) != -1; } ),
    RevInstDefaults().SetMnemonic("not %rd, %rs"         ).SetFunct3(   0b100).SetImplFunc(xori  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011).SetPredicate( []( uint32_t Inst ) { return SignExt( DECODE_IMM12( Inst ), 12 ) == -1; } ),
    RevInstDefaults().SetMnemonic("ori %rd, %rs1, $imm"  ).SetFunct3(   0b110).SetImplFunc(ori   ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011),
    RevInstDefaults().SetMnemonic("andi %rd, %rs1, $imm" ).SetFunct3(   0b111).SetImplFunc(andi  ).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm)                        .SetFormat(RVTypeI).SetOpcode(0b0010011),

    RevInstDefaults().SetMnemonic("slli %rd, %rs1, $imm" ).SetFunct3(   0b001).SetImplFunc(slli  ).SetFunct2or7(0b0000000).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm).SetFormat(RVTypeI).SetOpcode(0b0010011),
    RevInstDefaults().SetMnemonic("srli %rd, %rs1, $imm" ).SetFunct3(   0b101).SetImplFunc(srli  ).SetFunct2or7(0b0000000).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm).SetFormat(RVTypeI).SetOpcode(0b0010011),
    RevInstDefaults().SetMnemonic("srai %rd, %rs1, $imm" ).SetFunct3(   0b101).SetImplFunc(srai  ).SetFunct2or7(0b0010000).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FImm).SetFormat(RVTypeI).SetOpcode(0b0010011),
    ...
    RevInstDefaults().SetMnemonic("fence"                ).SetFunct3(   0b000).SetImplFunc(fence ).SetrdClass(RevRegClass::RegUNKNOWN).Setrs1Class(RevRegClass::RegUNKNOWN)             .SetFormat(RVTypeI).SetOpcode(0b0001111).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm(RevImmFunc::FVal),
    RevInstDefaults().SetMnemonic("ecall"                ).SetFunct3(   0b000).SetImplFunc(ecall ).SetrdClass(RevRegClass::RegUNKNOWN).Setrs1Class(RevRegClass::RegUNKNOWN)             .SetFormat(RVTypeI).SetOpcode(0b1110011).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm12(0b000000000000).Setimm(RevImmFunc::FEnc),
    RevInstDefaults().SetMnemonic("ebreak"               ).SetFunct3(   0b000).SetImplFunc(ebreak).SetrdClass(RevRegClass::RegUNKNOWN).Setrs1Class(RevRegClass::RegUNKNOWN)             .SetFormat(RVTypeI).SetOpcode(0b1110011).Setrs2Class(RevRegClass::RegUNKNOWN).Setimm12(0b000000000001).Setimm(RevImmFunc::FEnc),
  };

  // RV32C table
  std::vector<RevInstEntry> RV32ICTable = {
    RevCInstDefaults().SetMnemonic("c.addi4spn %rd, $imm" ).SetFunct3(   0b000).SetImplFunc(caddi4spn  ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCIW).SetOpcode(0b00).SetPredicate( []( uint32_t Inst ){ return ( ( Inst >> 5 ) & 0xff ) != 0; } ),
    RevCInstDefaults().SetMnemonic("c.lwsp %rd, $imm"     ).SetFunct3(   0b010).SetImplFunc(clwsp      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b10).SetPredicate( []( uint32_t Inst ){ return DECODE_RD( Inst ) != 0; } ),
    RevCInstDefaults().SetMnemonic("c.swsp %rs2, $imm"    ).SetFunct3(   0b110).SetImplFunc(cswsp      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCSS).SetOpcode(0b10),
    RevCInstDefaults().SetMnemonic("c.lw %rd, $rs1, $imm" ).SetFunct3(   0b010).SetImplFunc(clw        ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCL ).SetOpcode(0b00),
    RevCInstDefaults().SetMnemonic("c.sw %rs2, %rs1, $imm").SetFunct3(   0b110).SetImplFunc(csw        ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCS ).SetOpcode(0b00),
    RevCInstDefaults().SetMnemonic("c.j $imm"             ).SetFunct3(   0b101).SetImplFunc(cj         ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCJ ).SetOpcode(0b01),
    ...
    RevCInstDefaults().SetMnemonic("c.beqz %rs1, $imm"    ).SetFunct3(   0b110).SetImplFunc(cbeqz      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCB ).SetOpcode(0b01),
    RevCInstDefaults().SetMnemonic("c.bnez %rs1, $imm"    ).SetFunct3(   0b111).SetImplFunc(cbnez      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCB ).SetOpcode(0b01),
    RevCInstDefaults().SetMnemonic("c.li %rd, $imm"       ).SetFunct3(   0b010).SetImplFunc(cli        ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b01),
    RevCInstDefaults().SetMnemonic("c.lui %rd, $imm"      ).SetFunct3(   0b011).SetImplFunc(clui       ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b01).SetPredicate( []( uint32_t Inst ){ return DECODE_RD( Inst ) != 2; } ),
    RevCInstDefaults().SetMnemonic("c.addi16sp $imm"      ).SetFunct3(   0b011).SetImplFunc(caddi16sp  ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b01).SetPredicate( []( uint32_t Inst ){ return DECODE_RD( Inst ) == 2; } ),
    RevCInstDefaults().SetMnemonic("c.addi %rd, $imm"     ).SetFunct3(   0b000).SetImplFunc(caddi      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b01).SetPredicate( []( uint32_t Inst ){ return DECODE_RD( Inst ) != 0; } ),
    RevCInstDefaults().SetMnemonic("c.nop"                ).SetFunct3(   0b000).SetImplFunc(nop        ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b01).SetPredicate( []( uint32_t Inst ){ return DECODE_RD( Inst ) == 0; } ),
    RevCInstDefaults().SetMnemonic("c.slli %rd, $imm"     ).SetFunct3(   0b000).SetImplFunc(cslli      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCI ).SetOpcode(0b10),
    RevCInstDefaults().SetMnemonic("c.srli %rd, $imm"     ).SetFunct3(   0b100).SetImplFunc(csrli      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCB ).SetOpcode(0b01).SetFunct2(0b00),
    RevCInstDefaults().SetMnemonic("c.srai %rd, $imm"     ).SetFunct3(   0b100).SetImplFunc(csrai      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCB ).SetOpcode(0b01).SetFunct2(0b01),
    RevCInstDefaults().SetMnemonic("c.andi %rd, $imm"     ).SetFunct3(   0b100).SetImplFunc(candi      ).Setimm(RevImmFunc::FVal).SetFormat(RVCTypeCB ).SetOpcode(0b01).SetFunct2(0b10),
