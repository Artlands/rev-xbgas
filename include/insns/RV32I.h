...
namespace SST{
  namespace RevCPU{
    class RV32I : public RevExt {
      ...
      static bool cnop(RevFeature *F, RevRegFile *R, RevMem *M, RevInst Inst) {
      ...
      static bool cebreak(RevFeature *F, RevRegFile *R, RevMem *M, RevInst Inst) {
      ...
      static bool caddi16sp(RevFeature *F, RevRegFile *R, RevMem *M, RevInst Inst) {
      ...
      static bool clui(RevFeature *F, RevRegFile *R, RevMem *M, RevInst Inst) {
