...
class RV64A : public RevExt {
  ...
  std::vector<RevInstEntry> RV64ATable = {
    ...
    Rev64AInstDefaults().SetMnemonic("amoadd.d %rd, %rs1, %rs2" ).SetFunct2or7(0b0000000).SetImplFunc(amoaddd ),
    Rev64AInstDefaults().SetMnemonic("amoxor.d %rd, %rs1, %rs2" ).SetFunct2or7(0b0000100).SetImplFunc(amoxord ),
    Rev64AInstDefaults().SetMnemonic("amoand.d %rd, %rs1, %rs2" ).SetFunct2or7(0b0001100).SetImplFunc(amoandd ),
    Rev64AInstDefaults().SetMnemonic("amoor.d %rd, %rs1, %rs2"  ).SetFunct2or7(0b0001000).SetImplFunc(amoord  ),
    Rev64AInstDefaults().SetMnemonic("amomin.d %rd, %rs1, %rs2" ).SetFunct2or7(0b0010000).SetImplFunc(amomind ),
    Rev64AInstDefaults().SetMnemonic("amomax.d %rd, %rs1, %rs2" ).SetFunct2or7(0b0010100).SetImplFunc(amomaxd ),
    Rev64AInstDefaults().SetMnemonic("amominu.d %rd, %rs1, %rs2").SetFunct2or7(0b0011000).SetImplFunc(amominud),
    Rev64AInstDefaults().SetMnemonic("amomaxu.d %rd, %rs1, %rs2").SetFunct2or7(0b0011100).SetImplFunc(amomaxud),
  };
  // clang-format on
