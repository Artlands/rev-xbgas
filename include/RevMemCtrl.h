...
private:
  ...
  void setRmtMemCtrl( RevRmtMemCtrl* ctrl ) final { rmtMemCtrl = ctrl; }
...
#define AMOTABLE_IN     5
  ...
  struct ReadWritePair {
    std::tuple<uint32_t, unsigned char*, void*, RevFlag, RevMemOp*, bool> read{};
    std::tuple<uint32_t, unsigned char*, void*, RevFlag, RevMemOp*, bool> write{};
  };
