...
int main( int argc, char** argv ) {
  ...
  // Before AMO
  printf( "Before AMO And: PE %d: test_val = 0x%x, ret = 0x%x, val = 0x%x ", id, test_val, ret, val );
  ...
  printf( "After AMO And: PE %d: test_val = 0x%x, ret = 0x%x, val = 0x%x ", id, test_val, ret, val );
}
