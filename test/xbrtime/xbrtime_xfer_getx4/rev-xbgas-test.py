...
xbgas_cpu3 = sst.Component("cpu3", "revcpu.RevCPU")
xbgas_cpu3.addParams({
          "verbose" : 4,                                # Verbosity
          "numCores" : 1,                               # Number of cores
          "clock" : "1.0GHz",                           # Clock
          "memSize" : 2*1024*1024*1024,                   # Memory size in bytes
...
nic3 = xbgas_cpu3.setSubComponent("xbgas_nic", "revcpu.XbgasNIC")
...
iface3 = nic3.setSubComponent("iface", "merlin.linkcontrol")
...
link3.connect( (iface3, "rtr_port", "1ms"), (router, "port3", "1ms") )
