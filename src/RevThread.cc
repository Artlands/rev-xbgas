...
std::ostream& operator<<( std::ostream& os, const RevThread& Thread ) {
  ...
  case ThreadState::START: StateString = "START"; break;
  case ThreadState::READY: StateString = "READY"; break;
  case ThreadState::RUNNING: StateString = "RUNNING"; break;
  case ThreadState::BLOCKED: StateString = "BLOCKED"; break;
  case ThreadState::DONE: StateString = "DONE"; break;
