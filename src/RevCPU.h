  ...
  namespace RevCPU {
    ...
    public:
      ...
      SST_ELI_DOCUMENT_STATISTICS(
        {"SyncGetSend",         "Operation count for outgoing SyncGet Commands",        "count",  3},
        {"SyncPutSend",         "Operation count for outgoing SyncPut Commands",        "count",  3},
        {"AsyncGetSend",        "Operation count for outgoing AsyncGet Commands",       "count",  3},
        {"AsyncPutSend",        "Operation count for outgoing AsyncPut Commands",       "count",  3},
        {"SyncStreamGetSend",   "Operation count for outgoing SyncStreamGet Commands",  "count",  3},
        {"SyncStreamPutSend",   "Operation count for outgoing SyncStreamPut Commands",  "count",  3},
        {"AsyncStreamGetSend",  "Operation count for outgoing AsyncStreamGet Commands", "count",  3},
        {"AsyncStreamPutSend",  "Operation count for outgoing AsyncStreamPut Commands", "count",  3},
        {"ExecSend",            "Operation count for outgoing Exec Commands",           "count",  3},
        {"StatusSend",          "Operation count for outgoing Status Commands",         "count",  3},
        {"CancelSend",          "Operation count for outgoing Cancel Commands",         "count",  3},
        {"ReserveSend",         "Operation count for outgoing Reserve Commands",        "count",  3},
        {"RevokeSend",          "Operation count for outgoing Revoke Commands",         "count",  3},
        {"HaltSend",            "Operation count for outgoing Halt Commands",           "count",  3},
        {"ResumeSend",          "Operation count for outgoing Resume Commands",         "count",  3},
        {"ReadRegSend",         "Operation count for outgoing ReadReg Commands",        "count",  3},
        {"WriteRegSend",        "Operation count for outgoing WriteReg Commands",       "count",  3},
        {"SingleStepSend",      "Operation count for outgoing SingleStep Commands",     "count",  3},
        {"SetFutureSend",       "Operation count for outgoing SetFuture Commands",      "count",  3},
        {"RevokeFutureSend",    "Operation count for outgoing RevokeFuture Commands",   "count",  3},
        {"StatusFutureSend",    "Operation count for outgoing StatusFuture Commands",   "count",  3},
        {"SuccessSend",         "Operation count for outgoing Success Commands",        "count",  3},
        {"FailedSend",          "Operation count for outgoing Failed Commands",         "count",  3},
        {"BOTWSend",            "Operation count for outgoing BOTW Commands",           "count",  3},
        {"SyncGetRecv",         "Operation count for incoming SyncGet Commands",        "count",  3},
        {"SyncPutRecv",         "Operation count for incoming SyncPut Commands",        "count",  3},
        {"AsyncGetRecv",        "Operation count for incoming AsyncGet Commands",       "count",  3},
        {"AsyncPutRecv",        "Operation count for incoming AsyncPut Commands",       "count",  3},
        {"SyncStreamGetRecv",   "Operation count for incoming SyncStreamGet Commands",  "count",  3},
        {"SyncStreamPutRecv",   "Operation count for incoming SyncStreamPut Commands",  "count",  3},
        {"AsyncStreamGetRecv",  "Operation count for incoming AsyncStreamGet Commands", "count",  3},
        {"AsyncStreamPutRecv",  "Operation count for incoming AsyncStreamPut Commands", "count",  3},
        {"ExecRecv",            "Operation count for incoming Exec Commands",           "count",  3},
        {"StatusRecv",          "Operation count for incoming Status Commands",         "count",  3},
        {"CancelRecv",          "Operation count for incoming Cancel Commands",         "count",  3},
        {"ReserveRecv",         "Operation count for incoming Reserve Commands",        "count",  3},
        {"RevokeRecv",          "Operation count for incoming Revoke Commands",         "count",  3},
        {"HaltRecv",            "Operation count for incoming Halt Commands",           "count",  3},
        {"ResumeRecv",          "Operation count for incoming Resume Commands",         "count",  3},
        {"ReadRegRecv",         "Operation count for incoming ReadReg Commands",        "count",  3},
        {"WriteRegRecv",        "Operation count for incoming WriteReg Commands",       "count",  3},
        {"SingleStepRecv",      "Operation count for incoming SingleStep Commands",     "count",  3},
        {"SetFutureRecv",       "Operation count for incoming SetFuture Commands",      "count",  3},
        {"RevokeFutureRecv",    "Operation count for incoming RevokeFuture Commands",   "count",  3},
        {"StatusFutureRecv",    "Operation count for incoming StatusFuture Commands",   "count",  3},
        {"SuccessRecv",         "Operation count for incoming Success Commands",        "count",  3},
        {"FailedRecv",          "Operation count for incoming Failed Commands",         "count",  3},
        {"BOTWRecv",            "Operation count for incoming BOTW Commands",           "count",  3},
        {"CyclesWithIssue",     "Cycles with succesful instruction issue",              "count",  2},
        {"TotalCycles",         "Total clock cycles",                                   "count",  2},
        {"FloatsRead",          "Total SP floating point values read",                  "count",  2},
        {"FloatsWritten",       "Total SP floating point values written",               "count",  2},
        {"DoublesRead",         "Total DP floating point values read",                  "count",  2},
        {"DoublesWritten",      "Total DP floating point values written",               "count",  2},
        {"BytesRead",           "Total bytes read",                                     "count",  2},
        {"BytesWritten",        "Total bytes written",                                  "count",  2},
        {"FloatsExec",          "Total SP or DP float instructions executed",           "count",  2},
        {"RemoteGet",           "Operation count for remote memory Get Operations",     "count",  1},
        {"RemotePut",           "Operation count for remote memory Put Operations",     "count",  1},
        {"RemoteMemoryRead",    "Total bytes read from remote memory",                  "bytes",  1},
        {"RemoteMemoryWrite",   "Total bytes written to remote memory",                 "bytes",  1},
      )
    ...
    private:
      ...
      bool EnableXbgasStats;              ///< RevCPU: Flag for enabling XBGAS statistics
      ...
      // xBGAS Statistics
      Statistic<uint64_t>* RemoteGet;
      Statistic<uint64_t>* RemotePut;
      Statistic<uint64_t>* RemoteMemoryRead;
      Statistic<uint64_t>* RemoteMemoryWrite;
      // ----- Per Core Statistics 
      ...
      void UpdateXbgasStatistics();

      void registerXbgasStatistics();
