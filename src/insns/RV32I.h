  ...
  namespace RevCPU{
    class RV32I : public RevExt {
      ...
      static bool lui(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        if( F->IsRV32() ){
          // R->RV32[Inst.rd] = 0x00;
          // SEXT(R->RV32[Inst.rd], Inst.imm << 12, 32);
          if(Inst.rd != 0)
      ...
      static bool auipc(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        if( F->IsRV32() ){
          // R->RV32[Inst.rd] = 0x00;
          // R->RV32[Inst.rd] = (int32_t)(td_u32(Inst.imm << 12, 32)) + (int32_t)(R->RV32_PC);
          if(Inst.rd != 0)
            R->RV32[Inst.rd] = (int32_t)(R->RV32_PC) + (int32_t)(Inst.imm << 12);
          R->RV32_PC += Inst.instSize;
        }else{
          // R->RV64[Inst.rd] = 0x00;
          // R->RV64[Inst.rd] = (int32_t)(td_u32(Inst.imm << 12, 32)) + (int64_t)(R->RV64_PC);
          if(Inst.rd != 0)
      ...
      static bool jal(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        if( F->IsRV32() ){
          ...
          R->RV64_PC = (int64_t)(R->RV64_PC) + (int32_t)(td_u32(Inst.imm,20));
      ...
      static bool jalr(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        ...
        if( F->IsRV32() ){
          ...
          R->RV32_PC = ((int32_t)(td_u32(R->RV64[Inst.rs1],32)) + (int32_t)(td_u32(Inst.imm, 12))) & ~(1<<0);
          if(Inst.rd != 0)
            R->RV32[Inst.rd] = TMP32PC;
          R->RV32[0] = 0x00;  // ensure that x0 = 0
        }else{
          TMP64PC = R->RV64_PC + Inst.instSize;
          R->RV64_PC = ((int64_t)(td_u64(R->RV64[Inst.rs1],64)) + (int32_t)(td_u32(Inst.imm, 12))) & ~(1<<0);
          if(Inst.rd != 0)
      ...
      static bool slli(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        if( F->IsRV32() ){
          if(Inst.rd != 0)
            R->RV32[Inst.rd] = (int32_t)(R->RV32[Inst.rs1] << (Inst.imm & 0b11111));
          R->RV32_PC += Inst.instSize;
        }else{
      ...
      static bool srli(RevFeature *F, RevRegFile *R,RevMem *M, RevXbgas *Xbgas, RevInst Inst) {
        if( F->IsRV32() ){
          if(Inst.rd != 0)
            R->RV32[Inst.rd] = (int32_t)((uint32_t)R->RV32[Inst.rs1] >> (Inst.imm & 0b11111));
          R->RV32_PC += Inst.instSize;
        }else{
          // In RV64, bit-25 is used to shamt[5]
          if(Inst.rd != 0)
      ...
      std::vector<RevInstEntry> RV32ICTable = {
        ...
        {RevInstEntryBuilder<RevInstDefaults>().SetMnemonic("c.srli %rd, $imm"     ).SetCost(1).SetOpcode(0b01).SetFunct6(0b100000).SetFunct4(0b0   ).SetFunct3(0b100).SetFunct2(0b0 ).SetrdClass(RegGPR    ).Setrs1Class(RegGPR    ).Setrs2Class(RegUNKNOWN).Setimm(FImm).SetFormat(RVCTypeCI ).SetImplFunc(&csrli    ).SetCompressed(true).InstEntry},
        {RevInstEntryBuilder<RevInstDefaults>().SetMnemonic("c.srai %rd, $imm"     ).SetCost(1).SetOpcode(0b01).SetFunct6(0b100001).SetFunct4(0b0   ).SetFunct3(0b100).SetFunct2(0b0 ).SetrdClass(RegGPR    ).Setrs1Class(RegGPR    ).Setrs2Class(RegUNKNOWN).Setimm(FImm).SetFormat(RVCTypeCI ).SetImplFunc(&csrai    ).SetCompressed(true).InstEntry},
        ...
        {RevInstEntryBuilder<RevInstDefaults>().SetMnemonic("c.lwsp %rd, $imm"     ).SetCost(1).SetOpcode(0b10).SetFunct6(0b0     ).SetFunct4(0b0   ).SetFunct3(0b010).SetFunct2(0b0 ).SetrdClass(RegGPR    ).Setrs1Class(RegUNKNOWN).Setrs2Class(RegUNKNOWN).Setimm(FImm).SetFormat(RVCTypeCSS).SetImplFunc(&clwsp    ).SetCompressed(true).InstEntry},
